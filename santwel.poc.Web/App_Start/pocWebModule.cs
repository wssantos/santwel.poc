...
namespace santwel.poc.Web
{
    [DependsOn(
        ...
        typeof(pocDataModule), 
        typeof(pocApplicationModule), 
        typeof(pocWebApiModule))]
    public class pocWebModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Localization.Sources.Add(
                new DictionaryBasedLocalizationSource(
                    pocConsts.LocalizationSourceName,
                    new XmlFileLocalizationDictionaryProvider(
                        HttpContext.Current.Server.MapPath("~/Localization/poc")
                        )
                    )
                );
